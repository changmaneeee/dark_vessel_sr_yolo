...
<< COMMENT
RUN_TAG=arch2_selective_test1 \
PROJECT_ROOT=/home/octolab/dark_vessel_sr_yolo/iac_runs \
...
ARCH2_CONFIG=/home/octolab/dark_vessel_sr_yolo/configs/experiment/arch2_softgate.yaml \
ARCH2_PY=/home/octolab/dark_vessel_sr_yolo/src/models/pipelines/arch2_softgate.py \
ARCH2_GATE_THRESHOLD=0.5 \
MAX_IMAGES=200 \
WARMUP=20 \
DEVICE=cuda \
bash /home/octolab/dark_vessel_sr_yolo/jetson_runs/arch2_0308/run_arch2_selective_skip_jetson.sh
COMMENT
